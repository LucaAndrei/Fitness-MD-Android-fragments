...
public class WebSocket {
    private static final String THREAD_BASE_NAME = "Fitness";
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        Log.d("Fitness_WebsocketLib","IllegalAccessException");
                        e.printStackTrace();
                    } catch (InvocationTargetException e) {
                        Log.d("Fitness_WebsocketLib","InvocationTargetException");
                        e.printStackTrace();
                    }
                } catch (NoSuchMethodException e) {
                    throw new WebSocketException("Cannot call setHostname method");
                }
